"""Locomotion curriculum presets for the Tocabi robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

tocabi_33dof_curriculum = CurriculumManagerCfg(
    params={
...
tocabi_33dof_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["tocabi_33dof_curriculum", "tocabi_33dof_curriculum_fast_sac"]
