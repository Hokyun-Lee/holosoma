"""Whole Body Tracking reward presets for the Tocabi robot."""

from holosoma.config_types.reward import RewardManagerCfg, RewardTermCfg

_TOCABI_ALLOWED_CONTACTS_REGEX = (
    "^(?!L_Foot_Link$)(?!R_Foot_Link$)"
    "(?!L_AnkleRoll_Link$)(?!R_AnkleRoll_Link$)"
    "(?!L_Wrist2_Link$)(?!R_Wrist2_Link$).+$"
)

tocabi_33dof_wbt_reward = RewardManagerCfg(
    terms={
        ...
        "undesired_contacts": RewardTermCfg(
            ...
            params={
                "threshold": 1.0,
                "undesired_contacts_body_names": _TOCABI_ALLOWED_CONTACTS_REGEX,
            },
            weight=-0.1,
        ),
    }
...
tocabi_33dof_wbt_fast_sac_reward = RewardManagerCfg(
    terms={
        **tocabi_33dof_wbt_reward.terms,
        "action_rate_l2": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:penalty_action_rate",
            weight=-1.0,
        ),
...
__all__ = ["tocabi_33dof_wbt_fast_sac_reward", "tocabi_33dof_wbt_reward"]
